...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-static-top"style="background:rgb(226,30,72)" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                        <a href="menuPrincipalAdmin.php"><i class="fa fa-dashboard fa-fw" style="color:#FFD700;"></i><strong><b style="color:#17202A;"> MENU PRINCIPAL</b></strong></a>
                        </li>                                                                      
                        <li>
                            <a><i class="fa  fa-sign-out" style="color:#FFD700;"></i><b style="color:#17202A">  SALIR</b><span class="fa arrow"></span></b></a>
                            <ul class="nav nav-second-level">
                                                
                                <li>
                                    <a href="bd/cerrarSesion.php"style="color:#E91E63"><i class="fa  fa-sign-out" style="color:#0000ff;"></b></i> Cerrar Sesion</a>
                                </li>
                            </ul>
        ...
        <div id="page-wrapper">
                    ...
                    <div class="col-lg-12">
                        ...
                        <img src="lib/img/bannerPasaportes.png">
                    </div>
                    <!-- /.col-lg-12 -->
                    <br><br><br> 
                    <br><br><br>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        ...
                                        <div class="panel-footer">
                                            ...
                                            <h6><a href="tablaPasaportes.php"> <span class="pull-right"style="color:#1565C0;"><b>AGREGAR PASAPORTES</b></span></h6>								                             
                                ...
                                <div class="panel panel-red">
                                    <div class="panel-heading">
                                        ...
                                        <span class="pull-right"> &nbsp <i class="fa fa-arrow-circle-right" style="color:#039BE5"></i></span>
                                            <h6><a href="informacionPasaportes.php"> <span class="pull-right" style="color:#1565C0;"><b>INFORMACION PASAPORTES</b></span></h6>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="panel panel-primary">
                                    ...
                                    <span class="pull-right"> &nbsp <i class="fa fa-arrow-circle-right" style="color:#FF5722"></i></span>
                                        <h6><a href="eliminarPasaportes.php"> <span class="pull-right" style="color:#1565C0;"><b>ELIMINAR PASAPORTES</b></span></h6>								                             
                                        <div class="clearfix"></div>
                                    </div>
                                </a>
                                </div>
