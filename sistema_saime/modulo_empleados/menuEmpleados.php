...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-static-top"style="background:rgb(0,155,193)" role="navigation" style="margin-bottom: 0">
        ...
        <div class="col-lg-12">
            ...
            <img src="../lib/img/bannerEmpleados.png">
        </div>
            <!-- /.col-lg-12 -->
        <br><br><br>

            <!-- ---///////// 4 MODULOS IGUALES  GRUPO 1  /////////----------->

            <!-- ---//// MODULOS VISOL EMPLEADOS  /////////----------->

            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel" style="background-color:#03A9F4">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3" >
                                   <i class="fa fa-user-plus fa-3x" style="color:#283747"></i>
                                </div>
                        ...
                        <div class="panel-footer">
                            ...
                            <h6><a href="tablaEmpleados.php"> <span class="pull-right" style="color:#1565C0;"><b>AGREGAR EMPLEADOS</b></span></a> </h6>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel" style="background-color:#B3E5FC">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
                                    <i class="fa fa-graduation-cap fa-3x"style="color:#283747";></i>
                                </div>
                                <div class="col-xs-9 text-right"></div>
                        ...
                        <div class="panel-footer">          
                            ...
                            <h6><a href="informacionAcademica.php"> <span class="pull-right"style="color:#1565C0;"><b>INFORMACION ACADEMICA</b></span></a> </h6>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel" style="background-color:#ABB2B9">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
                                    <i class="fa  fa-book fa-3x" style="color:#283747";></i>
                                </div>
                                <div class="col-xs-9 text-right"> </div>
                        ...
                        <div class="panel-footer">    
                            ...
                            <h6><a href=" tabladatosAnexos.php"> <span class="pull-right"style="color:#1565C0;"><b>DATOS ANEXOS </b></span></a> </h6>
                            <div class="clearfix"></div>
                        </div>                 
                    </div>
                </div>

                 <!-- ---//// MODULOS VISOL INFORMACION ACADEMICA ////----------->

                <div class="col-lg-3 col-md-6">
                    <div class="panel" style="background-color:#D5D8DC">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
                                    <i class="fa fa-users fa-3x" style="color:#283747";></i>
                                </div>
                                <div class="col-xs-9 text-right"> </div>                              
                            </div>
                        </div>
                        <div class="panel-footer">     
                            ...
                            <h6><a href="informacionEmpleados1.php"> <span class="pull-right"style="color:#1565C0;"><b>INFORMACION EMPLEADOS</b></span></a> </h6>
                            <div class="clearfix"></div>
                        </div>
            ...
            <!-- ---///////// 4 MODULOS IGUALES GRUPO 2  /////////----------->

             <!-- ---//// MODULOS CONTROL PERMISOS ////----------->

            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel" style="background-color:#F1C40F ">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
                                    <i class="fa fa-hourglass-end fa-3x" style="color:#17202A";></i>
                                </div>
                                <div class="col-xs-9 text-right">  </div>                            
                            </div>
                        </div>
                        ...
                        <div class="panel-footer">
                            ...
                            <span class="pull-right"> &nbsp <i class="fa fa-arrow-circle-right" style="color:#1D8348"></i></span>
                            <h6><a href="permisosEmpleados.php"> <span class="pull-right"style="color:#1565C0;"><b>CONTROL PERMISOS</b></span></a> </h6>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>

                 <!-- ---//// MODULOS INFORMACION EMPLEADOS ////----------->

                <div class="col-lg-3 col-md-6">
                    <div class="panel" style="background-color:#F9E79F">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
                                    <i class="fa fa-user-secret  fa-3x" style="color:#17202A";></i>
                                </div>
                                <div class="col-xs-9 text-right"> </div>        
                            </div>
                        </div>
                        ...
                        <div class="panel-footer">    
                            ...
                            <span class="pull-right"> &nbsp <i class="fa fa-arrow-circle-right" style="color:#FF5722"></i></span>
                            <h6><a href="informacionEmpleados.php"> <span class="pull-right"style="color:#1565C0;"><b>INFORMACION EMPLEADOS</b></span></a> </h6>
                 ...
                 <!-- ---//// MODULOS VACACIONES EMPLEADOS ////----------->

                <div class="col-lg-3 col-md-6">
                    <div class="panel" style="background-color:#28B463">
                        <div class="panel-heading">
                            <div class="row">
                                    <div class="col-xs-3">
                                        <i class="fa fa-briefcase fa-3x" style="color:#17202A";></i>
                                    </div>
                            ...
                            <div class="panel-footer">     
                                ...
                                <span class="pull-right"> &nbsp <i class="fa fa-arrow-circle-right" style="color:#039BE5"></i></span>
                                <h6><a href="vacacionesEmpleados.php"> <span class="pull-right"style="color:#1565C0;"><b>VACACIONES</b></span></a> </h6>
                                <div class="clearfix"></div>
                            </div>                         
                    </div>
                </div>

                 <!-- ---//// MODULOS VISOL VACACIONES EMPLEADOS ////----------->

                <div class="col-lg-3 col-md-6">
                    <div class="panel" style="background-color:#82E0AA">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
                                    <i class="fa  fa-bus fa-3x" style="color:#17202A";></i>
                                </div>
                                <div class="col-xs-9 text-right">  </div>                                  
                            </div>
                        </div>
                        ...
                        <div class="panel-footer">     
                            ...
                            <span class="pull-right"> &nbsp <i class="fa fa-arrow-circle-right" style="color:#CC0033"></i></span></i></span>
                            <h6><a href="visolVacaciones.php"> <span class="pull-right"style="color:#1565C0;"><b>VISOL VACACIONES</b></span></a> </h6>
                            <div class="clearfix"></div>
                        </div>
