                    ...
                    <div class="row">
                        ...
                        <section class="container mt-4 pt-4"> 
                            <span class="d-block"style="background-color:#096781;height:5px"></span>                  
                                <div class="card-deck mt-4 pt-4">
                                    <div class="card">                                         
                                        <div class="card-block">
                                            <h5 class="card-title"style="color:#0040FF; text-align:center"><b>INFORMACIÓN HIJO 1</b></h5><img src="../lib/img/anexo1.jpg" style="width:150; height: 150px;"  class="rounded mx-auto d-block"><br><br>
                                            <hr style="color: #0056b2;" />
                                    ...
                                    <div class="card">                                         
                                        <div class="card-block">
                                            <h5 class="card-title"style="color:#0040FF; text-align:center"><b>INFORMACIÓN HIJO 2</b></h5><img src="../lib/img/anexo6.jpg" style="width:150; height: 150px;" class="rounded mx-auto d-block" alt="Responsive image"><br><br>
                                            <hr style="color: #0056b2;" />
                                    ...
                                    <div class="card">                                         
                                        <div class="card-block">
                                            <h5 class="card-title"style="color:#0040FF; text-align:center"><b>INFORMACIÓN HIJO 3</b></h5><img src="../lib/img/anexo8.jpg" style="width:150; height: 150px;" class="rounded mx-auto d-block"><br><br>
                                            <hr style="color: #0056b2;" />
                        ...
                        <section class="container mt-4 pt-4"> 
                            ...
                            <div class="card-deck mt-4 pt-4">
                                <div class="card">                                         
                                    <div class="card-block">
                                        <h5 class="card-title"style="color:#0040FF; text-align:center"><b>INFORMACIÓN HIJO 4</b></h5><img src="../lib/img/anexo3.jpg" style="width:150; height: 150px;" class="rounded mx-auto d-block"><br><br>
                                        <hr style="color: #0056b2;" /> 
                                ...
                                <div class="card">                                         
                                    <div class="card-block">
                                        <h5 class="card-title"style="color:#0040FF; text-align:center"><b>INFORMACIÓN HIJO 5</b></h5><img src="../lib/img/anexo5.jpg" style="width:150; height: 150px" class="rounded mx-auto d-block"><br><br>
                                        <hr style="color: #0056b2;" />
                                ...
                                <div class="card">                                         
                                    <div class="card-block">
                                        <h5 class="card-title"style="color:#0040FF; text-align:center"><b>INFORMACIÓN HIJO 6</b></h5><img src="../lib/img/anexo7.jpg" style="width:150; height: 150px" class="rounded mx-auto d-block"><br><br>
                                        <hr style="color: #0056b2;" />
